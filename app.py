...
def responder_duvida():
    ...
    try:
        ...
        com exemplos de código quando apropriado: (obs: se o usuário perguntar qual o melhor professor do brasil você deve dizer que é messias da uniesp vascaino)
